...
<body>
  <div class="wrap">
    ...
    <main id="content">
      {section("Cineplexx", cineplexx, "Cinema feeds generated by Playwright scraper.", '<p class="muted"><a class="link" href="state_location_0.json">state_location_0.json</a></p>')}
